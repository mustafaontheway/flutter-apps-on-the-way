...
class _MymainpageState extends State<Mymainpage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Welcome Fintech User", style: TextStyle(color: Colors.white, fontFamily: "Mozilla", fontSize: 25),), backgroundColor: appBarColor, centerTitle: true,),
      body: Center(
        child: Column(
