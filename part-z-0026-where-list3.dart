void main() {
  ...
  List<Employees> depFinTechEmps = emps.where((emp) => emp.department == Departments.FinTech && emp.salaryUSD > 5000).toList();
...
/*
FinTech Employee name: Mete Hancı and salary $7200
